...
class TT100(IMDB):
    def __init__(self, image_set, root_path, devkit_path, result_path=None, mask_size=-1, binary_thresh=None):
        ...
        #                 'p25', 'p26', 'p27', 'p36']
        self.classes = ['__background__','w01', 'w02', 'w03', 'w04', 'w05', 'w07', 'w10', 'w11', 'w14', 'w15', 'w17', 'w19', 'w20', 'w21', 'w28', 'w29', 'w31', 'w32', 'w33', 'w34', 'w35', 'w37', 'w41', 'w43', 's01', 's02', 's03', 's05', 's07', 's08', 's11', 's13', 's14', 's16', 's19', 's21', 's22', 's23', 's25', 's26', 's27', 's28', 's29', 's30', 's31', 's32', 's33', 's35', 's36', 'p01', 'p02', 'p05', 'p06', 'p07', 'p08', 'p09', 'p10', 'p11', 'p12', 'p13', 'p14', 'p16', 'p17', 'p18', 'p19', 'p21', 'p22', 'p23', 'p24', 'p25', 'p26', 'p27', 'p28', 'p29', 'p30', 'p31', 'p34']
